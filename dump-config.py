...
ALL_PARAMS = PARAMS_CONFIG_SAFETY + PARAMS_DIO_CONFIG + PARAMS_ANALOG_INPUT_CONFIG + PARAMS_PULSE_INPUT_CONFIG + PARAMS_ENCODER + PARAMS_POWER + PARAMS_MOTOR_CHAN + PARAMS_SEPEX
